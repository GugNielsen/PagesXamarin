...
//    {
//        int _yearStart = int.Parse(DateTime.Now.Year.ToString());
//        int _yearEnd = 0;
//       // int _month = int.Parse(DateTime.Now.Month.ToString());
//       //int _day = int.Parse(DateTime.Now.Day.ToString());
...
//            //for (int i = _day; i <= DateTime.DaysInMonth(DateTime.Now.Year, DateTime.Now.Month); i++)
//            {
//                if (i < 10)
//                {
//                    Day.Add("0" + i);
...
//            //populate year
//            for (int i = _yearStart; i < _yearEnd; i++)
//            {
//                Year.Add(i.ToString());
//            }
