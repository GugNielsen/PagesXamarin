...
namespace PagesXamarin.Utilities
{
	public class EncryptDecrypt
	{
        ...
        //    try
        //    {
        //        PasswordDeriveBytes pdb = new PasswordDeriveBytes(aesKey,
		...
		public static byte[] Encrypt(byte[] clearData, string Password)
		{
            ...
            //byte[] keyBytes = pdb.GetBytes(128 / 8);
            //var tst01 = pdb.GetBytes(32);
            //var tst02 = pdb.GetBytes(16);
    ...
    //    public static string EncryptAesManaged(string raw, byte[] aesKey)
    //    {
    //        try
    //        {
    //            string encrypteQrCode = String.Empty;
    ...
    //                encrypteQrCode = ByteArrayToString(encrypted);
    //                return encrypteQrCode;
    //            }
